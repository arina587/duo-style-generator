  ...
  },
  {
    ...
    referenceJobs: [
      ...
      },
      {
        ...
        prompt: 'Use image 1 as the exact base reference for scene, background, composition and camera.\n\nCRITICAL:\npreserve the entire scene exactly, but replace the characters with the uploaded man and woman using FULL head integration (not just faces).\n\nReplace heads and necks completely:\n- include jawline, neck, skin tone transition\n- ensure smooth blending between face, neck and body\n- match lighting and color exactly\n\nSTRICT identity preservation:\nsame facial structure, proportions, skin tone and recognizable features.\n\nIMPORTANT:\nmatch the cold night lighting precisely — skin tones must adapt to the scene lighting, not remain from the source images.\n\nPreserve:\n- exact pose and body positions\n- head angles and proximity\n- water level and reflections\n- camera perspective and framing\n\nKeep natural blur, reflections and cinematic softness.\n\nDo NOT change the scene — only integrate the new identities correctly into the lighting.\n\nFinal result must look like a real film frame with natural skin tone matching and seamless blending.',
      },
      {
        image: '/styles/titanic/ref3.jpg',
        prompt: 'Use image 1 as the exact base reference for scene, background, composition and camera.\n\nCRITICAL:\nuse FULL head and upper body integration instead of face-only replacement.\n\nReplace:\n- head\n- neck\n- visible upper body transitions\n\nEnsure:\n- correct skin tone blending with warm sunset lighting\n- no mismatch between face and neck color\n- no visible cut or mask effect\n\nSTRICT identity preservation:\nsame face structure, proportions, recognizable features.\n\nPreserve:\n- exact pose (man behind, hands on waist)\n- head angles and proximity\n- body alignment and framing\n\nLighting:\nmatch warm sunset light exactly, including highlights and shadows.\n\nBackground:\nship, sky and environment must remain unchanged.\n\nKeep cinematic softness and grain.\n\nFinal result must look like the same Titanic frame with fully integrated identities and correct lighting match.\n\nGoal:\nfix skin tone mismatch, ensure proper identity transfer, and avoid face-only artifacts.',
      },
    ],
    tag: 'Romance',
