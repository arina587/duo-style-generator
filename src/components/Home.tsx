    ...
    referenceJobs: [
      {
        ...
        animalPrompt: "Use image 1 as the exact base reference. Strictly preserve the original selfie composition, camera angle, framing, pose, head positions, gaze direction and expressions.\n\nIMPORTANT pose detail:\nthe right character must keep the arm placed around the left character's shoulder exactly like in the reference. Preserve contact, angle and spacing precisely.\n\nKeep the original animal characters exactly as they are:\nsame fox and bunny, same faces, same anatomy, same proportions.\nDo NOT replace faces.\nDo NOT convert to humans.\nDo NOT mix human facial structure.\n\nAllow slightly stronger but still subtle influence inspired by the uploaded images:\n- small expression nuances (eye shape, softness, mood)\n- very slight color tone resemblance\n- minimal personality alignment\nThis influence must remain soft and not change the original character identity.\n\nDo NOT modify paws into hands.\nDo NOT redesign faces.\nDo NOT add new elements.\n\nMaintain clean Pixar/Disney 3D style:\nsmooth shading, soft lighting, no realism.\n\nBackground must remain plain white exactly like the reference.\n\nFinal result must look almost identical to the original frame, but with slightly improved pose accuracy and a subtle hint of resemblance to the uploaded people.\n\nGoal:\nKeep stability (no errors), improve pose precision and slightly increase likeness without triggering transformation.",
      },
      {
