    ...
    referenceJobs: [
      {
        ...
        humanPrompt: "Recreate the scene from image 1 as a new image.\nDo NOT edit the original frame. Generate a new scene that matches it.\nMatch exactly:\n- same camera angle (slightly above, looking down)\n- same tight selfie framing\n- same head positions and proximity\n- same expressions\nCharacters:\n- man on the LEFT\n- woman on the RIGHT\nCRITICAL POSE:\nthe woman wraps her RIGHT arm around the man's neck from behind and her RIGHT hand rests naturally on top of his shoulder.\nThe hand must:\n- come from behind his neck\n- land on top of the shoulder (not side)\n- fingers gently curved over the shoulder\n- clearly visible and fully human\nThis fixes orientation (no left/right confusion).\nReplace characters with uploaded man and woman.\nSTRICT identity:\nsame facial structure, proportions, skin texture.\nStyle:\nPixar/Disney 3D, clean CGI, soft shading.\nBackground:\nplain white studio background.\nFinal result must look like a recreated version of the reference scene with correct pose and stable geometry.",
        animalPrompt: "Recreate the same scene from image 1 as a new image.\nDo NOT edit or transform the original frame.\nGenerate a nearly identical scene with:\n- same characters\n- same pose\n- same camera angle\n- same framing\nKeep characters fully as animals.\nDo NOT modify:\n- anatomy\n- face structure\n- proportions\nDo NOT apply any transformation.\nOnly allow minimal natural variation from regeneration.\nMaintain clean Pixar/Disney 3D style.\nBackground:\nplain white.\nFinal result must look like the same scene recreated, not edited.\nGoal:\nstable generation with no content errors and consistent pose.",
      },
      {
