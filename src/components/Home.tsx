  ...
  },
  {
    ...
    referenceJobs: [
      ...
      },
      {
        ...
        prompt: 'Use image 1 as the exact base reference. Keep the original frame unchanged: same ship background, same sky, same sunset lighting, same composition, same crop, same body positions, same hand placement, same distance between the faces, same head angles and gaze directions.\n\nDo NOT redraw or reinterpret the scene. Do NOT restage anything.\n\nIntegrate the uploaded man and woman into the exact existing shot.\n\nPreserve the original pose exactly:\n- the man remains behind the woman\n- his hands stay in the same place on her waist\n- the woman keeps the same head tilt and gaze\n- the distance between their faces remains unchanged\n\nIMPORTANT FOR THE MAN:\nhis face must be clearly transferred from the uploaded male identity, but still follow the original angle, shadow and partial visibility.\nDo NOT rotate his head.\nDo NOT frontalize his face.\nDo NOT change his gaze.\n\nIMPORTANT FOR THE WOMAN:\nkeep her exact original gaze direction and head tilt.\nPreserve her identity accurately.\n\nPreserve identity of both people:\nsame recognizable facial structure, proportions, eye shape, nose, lips, and natural skin character.\n\nIMPORTANT FOR SKIN:\nkeep natural human skin tones with warm sunset influence only.\nDo NOT create a mismatch between face, neck and body.\nDo NOT create a pasted or masked face look.\n\nPreserve the original sunset softness, color grading and cinematic atmosphere.\n\nFinal result must look like the same original Titanic frame, with both uploaded identities correctly integrated, the man clearly recognizable, the woman\'s original gaze preserved, and skin tones naturally matched.\n\nGoal:\nKeep the exact original frames of referenceJobs[7] and [8], improve male identity transfer, preserve original head angles and gaze, and prevent unnatural blue skin or face/neck mismatch.',
      },
    ],
    tag: 'Romance',
