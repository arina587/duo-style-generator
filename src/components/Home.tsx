    ...
    referenceJobs: [
      {
        ...
        humanPrompt: "Use image 1 as the exact base reference.\nCRITICAL:\npreserve the exact original selfie camera geometry:\n- camera is slightly above eye level\n- camera angled slightly downward\n- close-up framing (tight crop, faces fill the frame)\n- same lens perspective and distance\nDo NOT zoom out or change framing.\nPreserve exact character positions:\n- man on the LEFT\n- woman on the RIGHT\nCRITICAL HAND PLACEMENT:\nthe woman's RIGHT hand must rest on the man's RIGHT shoulder (viewer's left side).\nThe hand must be:\n- clearly visible\n- fully human with five fingers\n- fingers gently curved over the top of the shoulder\n- palm resting naturally, not gripping\nDo NOT allow:\n- wrong shoulder\n- mirrored placement\n- paw-like hand\n- missing fingers\n- floating hand\nPreserve exact pose:\n- same head tilt\n- same cheek proximity\n- same facial expressions\nReplace characters with uploaded man and woman.\nSTRICT identity:\nsame facial structure, proportions, skin texture, no smoothing.\nRender in Pixar/Disney 3D style:\nclean CGI, soft shading, expressive eyes, but still recognizable real people.\nBackground:\nplain white exactly as in reference.\nFinal result must match the reference framing, pose and geometry exactly, with correct hand placement and stable composition.",
        animalPrompt: "Use image 1 as the exact base reference.\nCRITICAL:\ndo NOT replace characters.\ndo NOT perform face swap.\ndo NOT introduce real human faces.\nKeep the original characters and composition exactly.\nApply ONLY a very subtle stylistic reinterpretation inspired by human traits:\n- slightly softer facial expressions\n- minimal personality variation\n- tiny aesthetic refinement\nDo NOT change:\n- character species\n- anatomy\n- proportions\n- pose\n- camera angle\n- background\nDo NOT add:\n- human skin\n- human facial structure\n- hybrid forms\nKeep full original Zootopia character design intact.\nMaintain clean Pixar/Disney rendering:\nsmooth shading, soft lighting.\nFinal result must look almost identical to the original frame, with only extremely subtle stylistic variation.\nGoal:\nperfectly stable generation with no errors and no content flags.",
      },
      {
