  ...
  },
  {
    ...
    referenceJobs: [
      ...
      },
      {
        ...
        prompt: 'Use image 1 as the exact base reference for scene, background, composition and camera.\n\nCRITICAL:\nthe scene must remain identical to the reference, but faces MUST be replaced with the uploaded people.\n\nReplace ONLY the faces of both characters with the uploaded man and woman.\n\nSTRICT identity transfer:\n- same facial structure\n- same proportions\n- same skin texture\n- same recognizable identity\n\nDo NOT leave original faces.\n\nPreserve:\n- exact body positions\n- head angles\n- distance between faces\n- water level and reflections\n- camera framing and perspective\n\nIMPORTANT:\ndo not change the scene — only integrate the new faces naturally into the existing frame.\n\nLighting:\nmatch original cold night lighting and reflections exactly.\n\nKeep natural blur, grain and cinematic softness.\n\nFinal result must look like the same Titanic frame with the new people realistically composited into it.',
      },
      {
        image: '/styles/titanic/ref3.jpg',
        prompt: 'Use image 1 as the exact base reference for scene, background, composition and camera.\n\nCRITICAL:\nthe scene must remain identical, but BOTH faces MUST be replaced with the uploaded identities.\n\nReplace ONLY the faces:\n- man → uploaded man\n- woman → uploaded woman\n\nSTRICT identity preservation:\nsame facial features, proportions, skin tone and structure.\n\nDo NOT keep original faces.\n\nPreserve:\n- exact pose (man behind, hands on waist)\n- head angles and proximity\n- body alignment\n- camera framing\n\nIMPORTANT:\ndo not alter the scene — only perform precise face integration.\n\nLighting:\nwarm sunset lighting must match the reference exactly.\n\nBackground:\nship, sky and environment must remain unchanged.\n\nKeep cinematic grain and softness.\n\nFinal result must look like the original Titanic frame with accurate face replacement.',
      },
    ],
    tag: 'Romance',
