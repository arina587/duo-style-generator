  ...
  },
  {
    ...
    referenceJobs: [
      ...
      },
      {
        ...
        prompt: 'Use image 1 as the ONLY source of scene, background, composition and camera.\n\nCRITICAL:\npreserve exact body positions — two people close together, leaning toward each other over the water surface.\n\nIMPORTANT:\nkeep the same distance between faces and the same head angles. No exaggeration.\n\nReplace with uploaded man and woman in identical positions.\n\nSTRICTLY preserve identity 1:1 — same facial structure, proportions, skin texture.\n\nLighting:\ncold dim night lighting. Preserve reflections and contrast exactly.\n\nBackground:\nSTRICTLY keep water surface, reflections and environment unchanged.\n\nKeep natural blur and cinematic softness.\n\nDo NOT add new elements.\n\nDo NOT change pose or camera.\n\nFinal result must look like the same original frame with replaced identities.',
      },
      {
        image: '/styles/titanic/ref3.jpg',
        prompt: 'Use image 1 as the ONLY source of scene, background, composition and camera.\n\nCRITICAL:\npreserve exact pose — man behind the woman, holding her around the waist, both slightly leaning toward each other.\n\nPreserve:\n- hand placement on waist\n- head angle and proximity\n- body alignment\n- framing and perspective\n\nReplace with uploaded man and woman in identical positions.\n\nSTRICTLY preserve identity 1:1 — same faces, proportions, skin texture. No smoothing.\n\nLighting:\nwarm sunset cinematic light. Preserve tones exactly.\n\nBackground:\nSTRICTLY keep ship, sky and lighting identical to the reference.\n\nDo NOT change composition, perspective or environment.\n\nFinal result must look like the original cinematic shot with the new people seamlessly integrated.\n\nGoal:\nmaximum pose accuracy + strict background preservation + stable generation without triggering filters.',
      },
    ],
    tag: 'Romance',
