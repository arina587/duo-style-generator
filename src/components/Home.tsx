    ...
    referenceJobs: [
      {
        ...
        prompt: 'Use image 1 as the exact base reference. STRICTLY preserve the original composition, camera angle, framing, pose, head positions, gaze direction and depth of field.\n\nIMPORTANT:\nkeep the exact camera perspective — side close-up framing, woman on the left in focus, man on the right closer to camera and softly blurred.\n\nUltra-realistic cinematic scene. The woman on the left is in sharp focus, looking sideways at the man. The man is in the foreground, partially out of focus.\n\nReplace with uploaded woman (left) and man (right), keeping exact spatial layout.\n\nSTRICTLY preserve identity 1:1 — same facial features, proportions, skin texture. No smoothing, no filters.\n\nLighting:\nwarm dim indoor cinematic lighting. Preserve original tones exactly.\n\nBackground:\nSTRICTLY keep the original background unchanged — no alterations, no simplification, no added elements.\n\nDepth:\npreserve shallow depth of field exactly — woman sharp, man softly blurred.\n\nKeep film grain and natural softness.\n\nFinal result must look identical to the original frame, only with the new people.',
      },
      {
        image: '/styles/euphoria/ref2.jpg',
        prompt: 'Use image 1 as the exact base reference. STRICTLY preserve composition, camera angle, framing, subject positions and perspective.\n\nIMPORTANT:\nkeep the exact camera angle — slightly above and to the side, with the man leaning back and head tilted down toward the woman.\n\nUltra-realistic cinematic indoor scene. The man is the main subject, the woman is closer to camera and partially out of focus.\n\nReplace with uploaded man and woman in identical positions.\n\nSTRICTLY preserve identity 1:1 — same face structure, proportions, skin texture. No smoothing, no filters.\n\nLighting:\nwarm indoor lighting, soft shadows. Preserve original color grading exactly.\n\nBackground:\nSTRICTLY preserve the original environment — couch, wall, lighting, depth, all details must remain unchanged.\n\nDepth:\nmain subject clearer, foreground softly blurred.\n\nKeep slight grain and softness.\n\nFinal result must look like the same original film frame with replaced people.',
      },
      {
        image: '/styles/euphoria/ref3.jpg',
        prompt: 'Use image 1 as the exact base reference. STRICTLY preserve composition, camera angle, framing, body positions and perspective.\n\nIMPORTANT:\nkeep the exact top/side camera view of two girls lying on a bed facing each other.\n\nUltra-realistic cinematic bedroom scene. Two people lie on a bed facing each other in a relaxed conversation.\n\nReplace with uploaded people, keeping exact pose and interaction.\n\nSTRICTLY preserve identity 1:1 — same facial features, proportions, skin texture. No smoothing, no distortion.\n\nLighting:\nsoft warm ambient lighting. Preserve original tones exactly.\n\nBackground:\nSTRICTLY keep the full environment unchanged — bed, objects, room details, clutter, lighting, depth.\n\nDepth:\nnatural softness, slight blur where present.\n\nKeep grain and cinematic softness.\n\nFinal result must look identical to the original scene, only with the new people integrated.',
      },
    ],
    tag: 'Cinematic',
