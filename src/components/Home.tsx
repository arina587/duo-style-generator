    ...
    referenceJobs: [
      {
        ...
        animalPrompt: "Use image 1 as the exact base reference. Do not change composition, pose, camera angle, gaze or expressions.\n\nKeep characters as animals. Do NOT convert to humans. Do NOT introduce human facial structure or skin.\n\nApply only VERY subtle stylistic influence inspired by the uploaded images:\n- slight personality tone\n- minimal color nuance\n- soft expression variation\n\nPreserve original character design, anatomy, proportions and expressions exactly.\nDo NOT modify hands/paws into human forms.\nDo NOT redesign faces.\nDo NOT increase transformation strength.\n\nMaintain clean Pixar/Disney 3D style:\nsmooth shading, soft lighting, no realism.\n\nBackground must remain plain white exactly like the reference.\n\nFinal result must look almost identical to the original animated frame, with only minimal, barely noticeable stylistic influence.\n\nGoal:\nRestore stable working result. Fix hand anatomy in human mode and keep animal mode safe without triggering errors.",
      },
      {
