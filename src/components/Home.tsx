    ...
    referenceJobs: [
      {
        ...
        animalPrompt: "Use image 1 as the exact base reference. Strictly preserve the original selfie composition, camera angle, framing, pose, head positions, gaze direction and expressions.\n\nKeep the original animal characters exactly as they are:\nsame fox and bunny, same faces, same anatomy, same proportions.\nDo NOT replace faces.\nDo NOT convert to humans.\nDo NOT mix human facial features.\nDo NOT redesign characters.\nPreserve everything almost identical to the reference.\n\nAllow only extremely minimal influence inspired by the uploaded images:\n- very subtle expression nuance\n- very slight tone or color feeling\nThis influence must be barely noticeable.\n\nDo NOT change paws, face structure, or character design.\nDo NOT add new elements.\nDo NOT increase stylization.\n\nMaintain clean Pixar/Disney 3D style:\nsmooth shading, soft lighting, no realism.\n\nBackground must remain plain white exactly like the reference.\n\nFinal result must look almost identical to the original frame, with only extremely subtle variation.\n\nGoal:\nKeep animal mode stable and prevent errors by avoiding any transformation, while preserving the exact original scene.",
      },
      {
