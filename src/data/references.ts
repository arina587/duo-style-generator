...
export const references: ReferenceItem[] = [
  ...
  // ── Tangled ──
  {
    ...
    prompt: "Use the provided animated reference image and separately uploaded photos of the man and woman.\nSTRICTLY preserve their identity 1:1 — facial structure, proportions, age, skin tone, eyes, nose, lips, hairstyle, hair color and length must remain clearly recognizable.\n\nCRITICAL: convert both people into the SAME Pixar/Disney-style 3D animated characters as in the reference — smooth stylized skin, expressive eyes, soft shading, but with strong identity retention.\n\nCRITICAL: perform full character replacement — replace the male character with the man and the female character with the woman, while preserving the exact animated style.\n\nCRITICAL POSE LOCK:\nExact 1:1 replication —\nthe woman stands in front with arms extended outward;\nthe man stands behind her, holding her gently.\nPreserve exact body positions, arm angles, posture, and head tilt.\n\nCRITICAL FACE INTEGRATION:\nFaces must be stylized into Pixar form but still clearly recognizable as the real people.\nMatch head angle, gaze direction, and expression exactly.\n\nCRITICAL STYLE LOCK:\nKeep the original animated rendering style EXACTLY — lighting, shading, color palette, softness, and proportions must match the reference.\n\nCRITICAL BACKGROUND & CLOTHING:\nKeep lanterns, castle, water reflections, environment, and costumes EXACTLY unchanged.\n\nCRITICAL HANDS:\nHands must be anatomically correct — five fingers, clean stylized anatomy, no deformation.\n\nHigh-quality Pixar-style CGI, cinematic warm lighting, soft glow, 4K.",
  },
  {
    id: 'tangled-2',
    style: 'tangled',
    ...
    prompt: "Use the provided animated reference image and separately uploaded photos of the man and woman.\nSTRICTLY preserve identity 1:1 — all facial features must remain recognizable even after stylization.\n\nCRITICAL: transform both into Pixar/Disney-style 3D characters matching the reference exactly — same stylized proportions, shading, and rendering.\n\nCRITICAL CHARACTER REPLACEMENT:\nReplace the male character with the man and the female character with the woman.\nDo not keep original faces.\n\nCRITICAL POSE LOCK:\nExact 1:1 replication —\nboth characters sitting close together;\nthe man slightly leaning forward with hands resting down;\nthe woman leaning toward him, resting her chin on her hands.\nPreserve exact posture, spacing, head tilt, and gaze direction.\n\nCRITICAL LIGHTING MATCH:\nFaces must inherit the original low-light warm glow from below (lantern/fire light), with soft shadows and cinematic darkness.\nNo over-brightening, no flat lighting.\n\nCRITICAL STYLE LOCK:\nKeep full animated look — soft gradients, stylized skin, expressive eyes, smooth geometry.\n\nCRITICAL BACKGROUND & CLOTHING:\nEnvironment, lighting, colors, and costumes remain EXACTLY the same as the reference.\n\nCRITICAL HANDS:\nHands must be correct — five fingers, proper stylized anatomy, no artifacts.\n\nCinematic Pixar-style night scene, warm glow lighting, soft shadows, high detail, 4K.",
  },
  {
    id: 'tangled-3',
    style: 'tangled',
    ...
    prompt: "Use the provided animated reference image and separately uploaded photos of the man and woman.\nSTRICTLY preserve identity 1:1 — facial structure and features must remain recognizable after stylization.\n\nCRITICAL: convert both into Pixar/Disney-style characters identical in rendering style to the reference — same proportions, shading, and material quality.\n\nCRITICAL CHARACTER REPLACEMENT:\nReplace the male character with the man and the female character with the woman completely.\n\nCRITICAL POSE LOCK:\nExact 1:1 replication —\nthe man is seated and tied with hair;\nthe woman is leaning toward him, one arm extended, looking directly at him.\nPreserve exact body positions, angles, head orientation, and interaction.\n\nCRITICAL FACE ALIGNMENT:\nMatch facial orientation precisely — no rotation errors, no frontal correction.\nKeep expressions consistent with the scene.\n\nCRITICAL STYLE & RENDERING:\nMaintain full Pixar-style look — stylized eyes, soft lighting, smooth textures, no photorealism.\n\nCRITICAL BACKGROUND & CLOTHING:\nCastle background, lighting, colors, rope, hair, and costumes must remain EXACTLY unchanged.\n\nCRITICAL HANDS:\nHands must be anatomically correct — five fingers, no deformation.\n\nHigh-quality Pixar-style CGI, soft daylight lighting, cinematic clarity, 4K.",
  },
