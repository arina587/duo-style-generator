...
export const references: ReferenceItem[] = [
  ...
  // ── Euphoria ──
  {
    ...
    prompt: "Use the provided movie reference image and separately uploaded photos of the man and woman.\nSTRICTLY preserve their identity 1:1 — facial structure, proportions, age, skin tone, eye shape, lips, nose, hairstyle, hair color and length must remain highly recognizable.\n\nCRITICAL: perform seamless face replacement ONLY — do not recreate or redraw the scene. Faces must be embedded into the original frame with full lighting and color matching.\n\nCRITICAL BACKGROUND LOCK:\nThe background, sofa, lighting, composition, colors, grain and depth of field must remain EXACTLY identical to the reference image.\nDO NOT modify, repaint, enhance, restyle, or regenerate the environment.\nNO background changes under any circumstances.\n\nCRITICAL POSE LOCK:\nExact 1:1 replication —\nwoman in sharp focus, slightly turned, looking sideways;\nman in foreground, partially blurred, in profile.\nKeep exact camera angle, framing, and depth of field.\n\nCRITICAL FACE INTEGRATION:\nFaces must inherit original lighting (warm amber), shadows, blur, and grain.\nDo not sharpen blurred areas. Do not over-clean skin.\n\nCRITICAL VISIBILITY RULE:\nReplace only visible facial areas. Do not reconstruct hidden geometry.\n\nCRITICAL HANDS:\nIf visible — five fingers, correct anatomy.\n\nCinematic close-up, shallow depth of field, warm indoor lighting, film grain, photorealistic, 4K.",
  },
  {
    id: 'euphoria-2',
    style: 'euphoria',
  ...
  },
  {
    ...
    prompt: "Use the provided movie reference image and separately uploaded photos of the man and woman.\nSTRICTLY preserve identity 1:1 — all facial features must remain highly recognizable, with correct proportions and no distortion.\n\nCRITICAL: precise face replacement with perspective matching — faces must be aligned to the original head orientation, camera angle, and lens distortion. No warping or misalignment.\n\nCRITICAL BACKGROUND LOCK:\nDo NOT modify anything except faces.\nHallway, lockers, students, lighting, motion blur, depth — must remain EXACTLY identical to the reference.\n\nCRITICAL POSE LOCK:\nExact 1:1 replication —\nfull-body walking shot, man on the left, woman on the right, holding hands.\nPreserve stride, posture, spacing, arm positions exactly.\n\nCRITICAL FACE ALIGNMENT:\nFaces must match the original head tilt, perspective, and distance to camera.\nNo face rotation, no frontal correction, no symmetry correction.\nKeep natural imperfections from motion and lens perspective.\n\nCRITICAL HANDS:\nHands must be fully correct — five fingers per hand, natural grip while holding hands, no deformation.\n\nCRITICAL CLOTHING:\nClothing must remain EXACTLY as in reference — no changes in shape, color, or texture.\n\nCRITICAL DEPTH & MOTION:\nPreserve original motion feel and slight cinematic softness if present. Do not over-sharpen faces.\n\nCinematic realism, natural indoor lighting, high detail, 4K.",
  },
