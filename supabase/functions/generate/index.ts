...
const WALLSTREET_1 = `Replace the person in the template image with the person from the uploaded reference photo. Use the reference photo to capture the person's appearance, including facial features, hairstyle, skin tone, and overall look.

Keep the facial expression, smile, gaze direction, head position, pose, body language, clothing, sunglasses, watch, yacht setting, camera angle, framing, lighting, shadows, depth of field, and overall composition from the template image.

Create a natural and realistic result that blends the appearance of the reference person into the template scene while maintaining the expression and pose from the template.

Photorealistic, high detail, natural skin texture, realistic lighting, seamless integration, professional lifestyle photography.

Do not modify the background, environment, furniture, accessories, clothing, or image composition. Only replace the person.`;
