...
const WALLSTREET_1 = `Replace the two original characters in the Wolf of Wall Street cinematic scene with the exact people from the provided reference images using complete identity transfer and seamless photorealistic integration. Preserve the exact composition, framing, energy, body positioning, and confident dynamic between the two subjects. The final result must look like a real cinematic movie still captured naturally in-camera. Left side — male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: face structure jawline and cheekbones nose shape lips and mouth structure authentic confident expression from the reference eyes and natural eye intensity hairstyle and hair texture hair color skin tone and realistic skin texture neck proportions body proportions posture and subtle body energy clothing style adaptation overall masculine identity and realistic human presence Keep the exact original pose: same shoulder angle same head position same body orientation same cinematic framing Right side — female replacement: Completely replace the original woman with the woman from the female reference image. Transfer exactly: facial structure eyes and authentic emotional gaze eyebrows lips and natural mouth shape realistic confident expression from the reference hairstyle and natural hair flow hair color skin tone and skin pores body proportions posture clothing adaptation overall identity and feminine presence Keep the exact original pose: same body angle same head position same eye direction same cinematic composition Critical realism requirements: Perfectly match: warm studio or office lighting realistic skin shading cinematic color grading authentic lens characteristics shallow depth of field natural skin reflections. Extremely important anatomy requirements: anatomically correct hands correct number of fingers no extra fingers no fused fingers no duplicated limbs realistic shoulders realistic neck connection natural torso proportions. Preserve completely: original cinematic background office or trading floor environment framing and camera angle Ultra photorealistic cinematic DSLR movie still, highly detailed skin texture, realistic anatomy, emotionally authentic expressions, cinematic lighting, seamless identity replacement, invisible compositing quality. Negative prompt: extra fingers, extra hands, fused fingers, duplicated limbs, malformed anatomy, broken arms, distorted face, bad anatomy, stiff posture, unnatural neck, distorted shoulders, bad perspective, mismatched lighting, poor compositing, pasted subject, CGI, 3D render, cartoon, anime, illustration, painting, wax skin, blurry details, low quality, oversaturated colors, watermark, text, logo`;

const WALLSTREET_2 = `Replace the two original people in the Wolf of Wall Street trading floor or office scene with the exact people from the supplied reference images using complete identity transfer and seamless cinematic integration. Preserve the original high-energy atmosphere, confident body language, and the powerful dynamic between the two subjects. The final image must look like a naturally photographed cinematic movie still. Left side — male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: face structure eyes and natural eye expression authentic confident smile from the reference lips and mouth shape hairstyle and hair texture hair color skin tone and realistic skin texture body proportions posture and natural masculine body language suit or clothing style adaptation overall identity and powerful presence. Keep the exact original pose and position naturally integrated into the cinematic environment. Right side — female replacement or second male replacement: Completely replace the original person with the person from the matching reference image. Transfer exactly: face structure hairstyle and hair texture eyes and gaze direction authentic expression from the reference natural facial emotion skin tone posture proportions body language clothing adaptation overall identity and cinematic presence. Keep the exact original position and posture matching the camera angle. Critical realism requirements: Perfectly preserve: warm tungsten or office lighting cinematic color grading realistic ambient bounce light original room or trading floor perspective depth of field natural skin reflections realistic facial shading. Anatomy requirements: correct number of fingers anatomically correct hands no extra fingers no fused fingers no duplicated limbs realistic wrist anatomy physically accurate arm positioning natural finger placement correct shoulder structure realistic neck connection. Ensure: seamless compositing invisible editing quality accurate scale and proportions natural interaction between both subjects. Preserve completely: original cinematic background environment framing and camera angle Wolf of Wall Street cinematic atmosphere Ultra photorealistic DSLR movie still, cinematic realism, highly detailed skin texture, realistic lighting, natural anatomy, seamless environmental integration, invisible compositing quality. Negative prompt: extra fingers, extra hands, duplicated limbs, malformed hands, broken anatomy, distorted fingers, fused fingers, warped arms, unnatural pose, stiff body, fake smile, artificial emotion, mismatched expression, pasted subject, floating body parts, bad anatomy, CGI, 3D render, cartoon, anime, blurry details, oversaturated colors, poor compositing, unrealistic lighting, low quality, watermark, text, logo`;

const WALLSTREET_3 = `Replace the two original people in the Wolf of Wall Street cinematic scene with the two real people from the uploaded reference photos while preserving the original composition, framing, lighting, mood, and camera perspective. Use the uploaded reference photos as the primary visual reference for both individuals: preserve recognizable facial features, preserve hairstyle and natural hair texture, preserve approximate body proportions, preserve clothing style and accessories, maintain natural expressions and realistic confidence. MALE REPLACEMENT: Replace the man in the scene with the male from the uploaded reference image. Preserve recognizable hairstyle and facial structure. Preserve suit or outfit style. Maintain confident charismatic posture. Naturally integrate him into the position and camera perspective. FEMALE REPLACEMENT: Replace the woman with the female from the uploaded reference image. Preserve recognizable hairstyle, facial features, and jewelry. Preserve clothing style. Naturally integrate her posture and arm placement into the scene. Scene requirements: photorealistic cinematic integration, realistic skin texture and natural cinematic lighting, matching warm lighting and shadows, shallow depth of field, believable perspective and proportions, seamless compositing, natural interaction between both people, preserve the high-energy Wolf of Wall Street cinematic atmosphere. Keep the original: background environment, composition and framing, emotional tone, cinematic lighting. Quality requirements: realistic anatomy, correct hands and fingers, no duplicated limbs, natural posture, realistic clothing folds, accurate neck and shoulder alignment, invisible editing quality, DSLR cinematic realism. Negative prompt: low quality, blurry face, distorted anatomy, extra fingers, duplicated limbs, malformed hands, incorrect perspective, warped body, unrealistic skin, overprocessed face, CGI look, cartoon, anime, painting, artificial facial features, floating body parts, bad lighting, mismatched proportions, poor compositing, text, watermark, logo`
...
const COLLAGE_5 = `Replace the two original characters in the Mr. & Mrs. Smith cinematic action or dramatic scene with the exact people from the provided reference images using complete identity transfer and seamless photorealistic integration. Preserve the exact composition, framing, stylish dynamic energy, body positioning, and powerful interaction between the two subjects. The final result must look like a real cinematic movie still. Male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: face structure jawline cheekbones nose lips confident intense expression from the reference eyes and gaze hairstyle hair texture skin tone body proportions posture stylish clothing adaptation overall masculine identity and presence. Keep the exact original pose. Female replacement: Completely replace the original woman with the woman from the female reference image. Transfer exactly: facial structure eyes eyebrows lips confident expression hairstyle hair flow skin tone body proportions posture stylish clothing adaptation overall identity. Keep the exact original pose. Perfectly match: dramatic cinematic lighting action or studio atmosphere color grading shallow depth of field realistic skin texture. Anatomy requirements: correct number of fingers anatomically correct hands no extra fingers no fused fingers no duplicated limbs natural posture. Preserve completely: original cinematic background framing camera angle stylish atmosphere. Ultra photorealistic DSLR movie still, highly detailed skin texture, realistic anatomy, emotionally authentic expressions, dramatic cinematic lighting, seamless identity replacement. Negative prompt: extra fingers, fused fingers, duplicated limbs, malformed hands, bad anatomy, distorted face, poor compositing, CGI, cartoon, anime, blurry, watermark, text, logo`;

const COLLAGE_6 = `Replace the two original characters in the Spider-Man romantic cinematic scene with the exact people from the provided reference images using complete identity transfer and seamless photorealistic integration. Preserve the exact composition, framing, emotional atmosphere, body positioning, and connection between the two subjects. The final result must look like a real cinematic movie still. Male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: face structure jawline cheekbones nose lips authentic expression from the reference eyes and natural gaze hairstyle hair texture skin tone body proportions posture clothing adaptation overall identity. Keep the exact original pose. Female replacement: Completely replace the original woman with the woman from the female reference image. Transfer exactly: facial structure eyes eyebrows lips natural expression hairstyle hair flow skin tone body proportions posture clothing adaptation overall identity. Keep the exact original pose. Perfectly match: cinematic lighting natural atmosphere color grading shallow depth of field realistic skin texture. Anatomy requirements: correct number of fingers anatomically correct hands no extra fingers no fused fingers no duplicated limbs natural posture. Preserve completely: original cinematic background framing camera angle atmospheric mood. Ultra photorealistic DSLR movie still, highly detailed skin texture, realistic anatomy, emotionally authentic expressions, cinematic lighting, seamless identity replacement. Negative prompt: extra fingers, fused fingers, duplicated limbs, malformed hands, bad anatomy, distorted face, poor compositing, CGI, cartoon, anime, blurry, watermark, text, logo`;

const SMITH_1 = `Replace the two original people in this intimate slow-dance cinematic ballroom scene with the exact individuals from the provided reference images using complete identity transfer and seamless photorealistic integration. Preserve the exact composition, framing, body positioning, romantic interaction, emotional tension, and elegant atmosphere of the original photograph. The final image must look like an authentic high-end cinematic movie still captured by a professional photographer.

Male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: facial structure, jawline, cheekbones, nose, lips, eyes, gaze direction, hairstyle, hair texture, skin tone, realistic skin details, body proportions, posture, suit adaptation, and overall identity. Preserve the exact pose, hand placement, embrace, and facial proximity to the female subject.

Female replacement: Completely replace the original woman with the woman from the female reference image. Transfer exactly: facial structure, eyes, eyebrows, nose, lips, expression, hairstyle, hair texture, skin tone, realistic skin details, body proportions, elegant black evening dress adaptation, posture, and overall identity. Preserve the exact pose, arm placement around the male subject, body angle, and intimate interaction.

Preserve exactly: close romantic slow-dance pose, near-kiss moment, emotional chemistry, elegant ballroom environment, shallow depth of field, warm ambient lighting, blurred guests in the background, cinematic bokeh, soft highlights on skin and hair, professional event photography aesthetics, natural perspective, original framing, camera angle, and realistic depth.

Perfectly match: warm golden cinematic color grading, luxurious evening atmosphere, photorealistic skin texture, realistic clothing folds, authentic body language, subtle facial expressions, natural shadows, premium DSLR photography quality, movie-like realism, seamless face and identity integration.

Anatomy requirements: anatomically correct hands, correct fingers, no fused fingers, no extra fingers, no duplicated limbs, realistic arm positioning, natural body proportions, accurate facial symmetry, realistic eye alignment.

Ultra photorealistic, cinematic romance movie still, luxury ballroom event, highly detailed skin texture, realistic anatomy, emotional authenticity, professional photography, shallow depth of field, warm cinematic lighting, seamless identity replacement, 85mm lens, f/1.8, premium film-grade color grading.

Negative prompt: extra fingers, fused fingers, missing fingers, duplicated limbs, malformed hands, broken anatomy, distorted face, asymmetrical eyes, poor compositing, bad face swap, low resolution, blurry, CGI, cartoon, anime, illustration, painting, overprocessed skin, unrealistic lighting, plastic skin, watermark, text, logo, artifacts, ghosting, double face, duplicated body parts, unnatural pose, deformed hands, uncanny valley.`;

const SMITH_2 = `Replace the two original characters in the intimate kitchen scene with the exact people from the provided reference images using complete identity transfer and seamless photorealistic integration. Preserve the exact composition, framing, body positioning, facial orientation, hand placement, and natural interaction between the two subjects. Maintain the warm, playful, romantic atmosphere and candid cinematic feel of the original scene. The final result must look like an authentic high-budget movie still.

Male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: face structure, jawline, nose, lips, eyes, gaze direction, subtle smile, hairstyle, skin tone, body proportions, posture, clothing adaptation, and overall masculine identity. Preserve the exact original pose, expression intensity, and interaction with the female subject.

Female replacement: Completely replace the original woman with the woman from the female reference image. Transfer exactly: facial structure, eyes, eyebrows, nose, lips, soft smiling expression, hairstyle, skin tone, body proportions, posture, clothing adaptation, and overall identity. Preserve the exact original pose, head angle, hand placement, and interaction with the male subject.

Perfectly preserve and match: modern luxury kitchen interior, sink and countertop details, warm natural indoor lighting, cinematic color grading, shallow depth of field, realistic skin texture, realistic fabric folds, subtle highlights and shadows, authentic environmental reflections, and natural photographic imperfections.

Anatomy: correct fingers, correct hand structure, no fused fingers, no extra fingers, no duplicated limbs, natural body proportions, realistic shoulders, realistic arms, accurate facial symmetry, natural posture.

Preserve: original background, camera angle, framing, composition, distance between subjects, romantic domestic atmosphere, candid movie-scene realism, cinematic depth, and photographic authenticity.

Ultra photorealistic DSLR movie still, Hollywood cinematic photography, highly detailed skin texture, realistic anatomy, emotionally authentic expressions, natural lighting, shallow depth of field, seamless identity replacement, premium color grading, realistic human proportions, true-to-life facial details, professional film production quality.

Negative prompt: extra fingers, fused fingers, missing fingers, duplicated limbs, malformed hands, distorted anatomy, deformed face, asymmetrical eyes, poor compositing, bad proportions, CGI, 3D render, cartoon, anime, painting, illustration, plastic skin, overprocessed skin, uncanny valley, blurry, low resolution, motion blur, watermark, text, logo, artifacts, duplicate people, incorrect pose, altered composition, unrealistic lighting.`;

const SMITH_3 = `Replace the two original tactical operatives in the action scene with the exact people from the provided reference images using complete identity transfer and seamless photorealistic integration. Preserve the exact composition, framing, tactical atmosphere, body positioning, weapon handling, armor placement, and interaction between the two subjects. The final result must look like a real cinematic sci-fi action movie still.

Male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: face structure, jawline, nose, lips, skin texture, eye shape, hairstyle, hairline, skin tone, body proportions, overall masculine identity, and focused alert expression. Preserve the exact original pose and body orientation. Head orientation is critical: keep the head turned approximately 35–45 degrees toward the woman, slightly lowered, eyes looking sideways toward her. Do not rotate, twist, or re-angle the head beyond the original perspective. Preserve the exact neck position and natural anatomical alignment.

Female replacement: Completely replace the original woman with the woman from the female reference image. Transfer exactly: facial structure, eyes, eyebrows, nose, lips, skin texture, hairstyle, skin tone, body proportions, overall identity, and determined focused expression. Preserve the exact original pose and body orientation. Head orientation is critical: keep the head facing mostly forward with a slight turn approximately 10–15 degrees to her left, chin level, eyes looking forward in the same direction as the original scene. Do not rotate, twist, or re-angle the head beyond the original perspective. Preserve the exact neck position and natural anatomical alignment.

Preserve precisely: both characters crouched in tactical positions, male positioned on the left side of the frame, female positioned on the right side of the frame, futuristic body armor, yellow tactical glasses, weapon placement, shoulder angles, torso rotation, arm positions, and the relative distance between the subjects.

Facial integration requirements: maintain original camera perspective, preserve correct facial foreshortening, match the exact viewing angle of each head, keep ears, jawline, cheekbones, and neck anatomy consistent with the original pose. Faces must conform naturally to the existing head orientation. No face swapping artifacts, no front-facing reconstruction, no profile distortion, no unnatural neck twisting, no head rotation mismatch.

Perfectly match: cinematic lighting, warm indoor sunlight, realistic shadows, movie-grade color grading, shallow depth of field, realistic skin texture, detailed armor materials, photorealistic reflections on yellow glasses, natural facial micro-details.

Anatomy: correct fingers, correct hand grip on weapons, no fused or extra fingers, no duplicated limbs, natural shoulders, realistic neck anatomy, correct eye alignment, proper facial perspective, physically accurate body proportions.

Preserve: original background, framing, camera angle, tactical tension, cinematic atmosphere, environmental lighting, depth, and composition.

Ultra photorealistic DSLR movie still, Hollywood sci-fi action film frame, highly detailed skin texture, realistic anatomy, seamless identity replacement, physically accurate facial perspective, cinematic lighting, professional color grading.

Negative prompt: extra fingers, fused fingers, duplicated limbs, malformed hands, bad anatomy, distorted face, warped jawline, asymmetrical eyes, incorrect facial perspective, front-facing face on angled head, twisted neck, rotated head, broken posture, face swap artifacts, poor compositing, CGI, cartoon, anime, blurry, low detail, watermark, text, logo, unnatural gaze direction, misaligned eyes, stretched facial features, deformed ears, unrealistic skin, plastic skin, uncanny valley.`;
