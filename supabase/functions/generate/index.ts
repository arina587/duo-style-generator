...
Match the exact cinematic lighting, warm vibrant color grading, skin texture, facial contours, highlights, depth, and Mediterranean summer atmosphere of the template image.

The inserted person should appear naturally photographed in the scene, not composited or edited. Preserve realistic facial volume, realistic shadow transitions, realistic skin texture, and seamless integration.

Keep the exact pose, hand placement, body posture, camera angle, framing, background, environment, depth of field, and composition unchanged. Preserve the warm romantic musical film composition, vivid summer colors, and cinematic visual quality characteristic of Mamma Mia!

Do not modify the background, environment, objects, or lighting setup.

Photorealistic, seamless integration, realistic anatomy, natural skin texture, realistic shadows, realistic facial structure, cinematic photography, high detail, vibrant warm colors, premium film-quality realism.`
...
Before generating the final image, completely remove both original subjects from the reference image.

Treat both original subjects as deleted placeholders.
...
The reference faces must be treated as non-existent.

Do not use reference faces for:
- facial geometry
- skull geometry
- proportions
- structure
- latent facial scaffold
- facial mesh
- topology
- reconstruction
...
The final people must contain 0% identity information from the reference subjects.
...
Then reconstruct the uploaded individuals and rotate them into the exact angles shown in the reference image.
...
- elegant soft smile
- romantic confidence
- warm subtle happiness
- identical smile intensity
- identical eye expression
- identical gaze direction
- identical head rotation
- identical neck twist
- identical over-the-shoulder pose
- identical body rotation
- identical posture
- identical framing
