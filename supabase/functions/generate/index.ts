...
const SMITH_2 = `Replace the two original characters in the Mr. & Mrs. Smith intense dramatic scene with the exact people from the provided reference images using complete identity transfer and seamless photorealistic integration. Preserve the exact composition, framing, tense atmosphere, body positioning, and charged interaction between the two subjects. The final result must look like a real cinematic movie still. Male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: face structure jawline nose lips intense focused expression eyes and gaze hairstyle skin tone body proportions posture clothing adaptation overall masculine identity. Keep the exact original pose. Female replacement: Completely replace the original woman with the woman from the female reference image. Transfer exactly: facial structure eyes eyebrows lips determined expression hairstyle skin tone body proportions posture clothing adaptation overall identity. Keep the exact original pose. Perfectly match: cinematic lighting dramatic atmosphere color grading shallow depth of field realistic skin texture. Anatomy: correct fingers no fused or extra fingers no duplicated limbs natural posture. Preserve: original background framing camera angle dramatic atmosphere. Ultra photorealistic DSLR movie still, highly detailed skin texture, realistic anatomy, emotionally authentic expressions, cinematic lighting, seamless identity replacement. Negative prompt: extra fingers, fused fingers, duplicated limbs, malformed hands, bad anatomy, distorted face, poor compositing, CGI, cartoon, anime, blurry, watermark, text, logo`;
