...
Keep the facial expression, smile, gaze direction, head position, pose, body language, hand gesture, clothing style, accessories, yacht setting, camera angle, framing, lighting, shadows, depth of field, and overall composition from the template image.

If the reference photo shows a woman, naturally place the woman into the template scene while preserving her appearance and body characteristics. If the reference photo shows a man, naturally place the man into the template scene while preserving his appearance and body characteristics.
...
Do not modify the background, environment, furniture, yacht, accessories, camera angle, or image composition. Only replace the entire person.`;
