...
const SMITH_1 = `Replace the two original characters in the Mr. & Mrs. Smith cinematic action couple scene with the exact people from the provided reference images using complete identity transfer and seamless photorealistic integration. Preserve the exact composition, framing, stylish dynamic energy, confident poses, and powerful interaction between the two subjects. The final result must look like a real cinematic movie still. Male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: face structure jawline cheekbones nose lips confident intense expression eyes and gaze hairstyle hair texture skin tone body proportions posture stylish suit or outfit adaptation overall masculine identity. Keep the exact original pose. Female replacement: Completely replace the original woman with the woman from the female reference image. Transfer exactly: facial structure eyes eyebrows lips confident expression hairstyle hair flow skin tone body proportions posture elegant clothing adaptation overall identity. Keep the exact original pose. Perfectly match: dramatic cinematic lighting action atmosphere color grading shallow depth of field realistic skin texture. Anatomy: correct fingers no fused or extra fingers no duplicated limbs natural posture. Preserve: original background framing camera angle stylish atmosphere. Ultra photorealistic DSLR movie still, highly detailed skin texture, realistic anatomy, emotionally authentic expressions, dramatic cinematic lighting, seamless identity replacement. Negative prompt: extra fingers, fused fingers, duplicated limbs, malformed hands, bad anatomy, distorted face, poor compositing, CGI, cartoon, anime, blurry, watermark, text, logo`;
