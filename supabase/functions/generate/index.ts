...
const WALLSTREET_1 = `Replace the original male subject in the main image with a new photorealistic male character inspired by the visual style and general appearance of the reference image.

Use the reference image only as guidance for broad aesthetic attributes such as face shape, hairstyle, hair color, skin tone, age range, and overall visual impression. Create a new unique individual rather than reproducing or identifying any real person.

Preserve the original composition, framing, camera angle, body position, posture, perspective, clothing, lighting, atmosphere, background elements, depth of field, shadows, reflections, and cinematic mood.

Maintain the exact pose, gaze direction, body language, and interaction with the environment. Ensure realistic anatomy, natural proportions, accurate hands, realistic skin texture, and physically consistent details throughout the scene.

Keep all environmental details, color grading, focus characteristics, and photographic realism unchanged. The result should look like a naturally captured photograph with seamless integration and no visible editing artifacts.

Ultra photorealistic DSLR photography, realistic skin texture, natural facial details, cinematic depth of field, highly detailed, professional color grading, authentic lighting, seamless compositing, realistic human anatomy, premium photography quality.

Negative prompt: extra fingers, fused fingers, missing fingers, duplicated limbs, malformed hands, distorted anatomy, asymmetrical eyes, warped facial features, deformed proportions, low resolution, blur, overprocessed skin, CGI look, cartoon, anime, illustration, painting, artifacts, watermark, text, logo, frame, caption.`;
