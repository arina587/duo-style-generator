...
const WALLSTREET_3 = `Replace the entire person in the template image with the person from the uploaded reference photo. Use the reference photo as the source of the person's appearance, including facial features, hairstyle, skin tone, body shape, body proportions, gender, and overall look.

The person should naturally recreate the facial expression, emotion, smile, gaze, head position, pose, body language, hand gestures, and overall attitude shown in the template image while maintaining the appearance of the reference person.
...
const SMITH_1 = `Replace the two original people in this intimate slow-dance cinematic ballroom scene with the exact individuals from the provided reference images using complete identity transfer and seamless photorealistic integration. Preserve the exact composition, framing, body positioning, romantic interaction, emotional tension, and elegant atmosphere of the original photograph. The final image must look like an authentic high-end cinematic movie still captured by a professional photographer. Male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: facial structure, jawline, cheekbones, nose, lips, eyes, gaze direction, hairstyle, hair texture, skin tone, realistic skin details, body proportions, posture, suit adaptation, and overall identity. Preserve the exact pose, hand placement, embrace, and facial proximity to the female subject. Female replacement: Completely replace the original woman with the woman from the female reference image. Transfer exactly: facial structure, eyes, eyebrows, nose, lips, expression, hairstyle, hair texture, skin tone, realistic skin details, body proportions, elegant black evening dress adaptation, posture, and overall identity. Preserve the exact pose, arm placement around the male subject, body angle, and intimate interaction. Preserve exactly: close romantic slow-dance pose, near-kiss moment, emotional chemistry, elegant ballroom environment, shallow depth of field, warm ambient lighting, blurred guests in the background, cinematic bokeh, soft highlights on skin and hair, professional event photography aesthetics, natural perspective, original framing, camera angle, and realistic depth. Perfectly match: warm golden cinematic color grading, luxurious evening atmosphere, photorealistic skin texture, realistic clothing folds, authentic body language, subtle facial expressions, natural shadows, premium DSLR photography quality, movie-like realism, seamless face and identity integration. Anatomy requirements: anatomically correct hands, correct fingers, no fused fingers, no extra fingers, no duplicated limbs, realistic arm positioning, natural body proportions, accurate facial symmetry, realistic eye alignment. Ultra photorealistic, cinematic romance movie still, luxury ballroom event, highly detailed skin texture, realistic anatomy, emotional authenticity, professional photography, shallow depth of field, warm cinematic lighting, seamless identity replacement, 85mm lens, f/1.8, premium film-grade color grading. Negative prompt: extra fingers, fused fingers, missing fingers, duplicated limbs, malformed hands, broken anatomy, distorted face, asymmetrical eyes, poor compositing, bad face swap, low resolution, blurry, CGI, cartoon, anime, illustration, painting, overprocessed skin, unrealistic lighting, plastic skin, watermark, text, logo, artifacts, ghosting, double face, duplicated body parts, unnatural pose, deformed hands, uncanny valley.`;

const SMITH_2 = `Replace the two original characters in the intimate kitchen scene with the exact people from the provided reference images using complete identity transfer and seamless photorealistic integration. Preserve the exact composition, framing, body positioning, facial orientation, hand placement, and natural interaction between the two subjects. Maintain the warm, playful, romantic atmosphere and candid cinematic feel of the original scene. The final result must look like an authentic high-budget movie still. Male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: face structure, jawline, nose, lips, eyes, gaze direction, subtle smile, hairstyle, skin tone, body proportions, posture, clothing adaptation, and overall masculine identity. Preserve the exact original pose, expression intensity, and interaction with the female subject. Female replacement: Completely replace the original woman with the woman from the female reference image. Transfer exactly: facial structure, eyes, eyebrows, nose, lips, soft smiling expression, hairstyle, skin tone, body proportions, posture, clothing adaptation, and overall identity. Preserve the exact original pose, head angle, hand placement, and interaction with the male subject. Perfectly preserve and match: modern luxury kitchen interior, sink and countertop details, warm natural indoor lighting, cinematic color grading, shallow depth of field, realistic skin texture, realistic fabric folds, subtle highlights and shadows, authentic environmental reflections, and natural photographic imperfections. Anatomy: correct fingers, correct hand structure, no fused fingers, no extra fingers, no duplicated limbs, natural body proportions, realistic shoulders, realistic arms, accurate facial symmetry, natural posture. Preserve: original background, camera angle, framing, composition, distance between subjects, romantic domestic atmosphere, candid movie-scene realism, cinematic depth, and photographic authenticity. Ultra photorealistic DSLR movie still, Hollywood cinematic photography, highly detailed skin texture, realistic anatomy, emotionally authentic expressions, natural lighting, shallow depth of field, seamless identity replacement, premium color grading, realistic human proportions, true-to-life facial details, professional film production quality. Negative prompt: extra fingers, fused fingers, missing fingers, duplicated limbs, malformed hands, distorted anatomy, deformed face, asymmetrical eyes, poor compositing, bad proportions, CGI, 3D render, cartoon, anime, painting, illustration, plastic skin, overprocessed skin, uncanny valley, blurry, low resolution, motion blur, watermark, text, logo, artifacts, duplicate people, incorrect pose, altered composition, unrealistic lighting.`;

const SMITH_3 = `Replace the two original tactical operatives in the action scene with the exact people from the provided reference images using complete identity transfer and seamless photorealistic integration. Preserve the exact composition, framing, tactical atmosphere, body positioning, weapon handling, armor placement, and interaction between the two subjects. The final result must look like a real cinematic sci-fi action movie still. Male replacement: Completely replace the original man with the man from the male reference image. Transfer exactly: face structure, jawline, nose, lips, skin texture, eye shape, hairstyle, hairline, skin tone, body proportions, overall masculine identity, and focused alert expression. Preserve the exact original pose and body orientation. Head orientation is critical: keep the head turned approximately 35-45 degrees toward the woman, slightly lowered, eyes looking sideways toward her. Do not rotate, twist, or re-angle the head beyond the original perspective. Preserve the exact neck position and natural anatomical alignment. Female replacement: Completely replace the original woman with the woman from the female reference image. Transfer exactly: facial structure, eyes, eyebrows, nose, lips, skin texture, hairstyle, skin tone, body proportions, overall identity, and determined focused expression. Preserve the exact original pose and body orientation. Head orientation is critical: keep the head facing mostly forward with a slight turn approximately 10-15 degrees to her left, chin level, eyes looking forward in the same direction as the original scene. Do not rotate, twist, or re-angle the head beyond the original perspective. Preserve the exact neck position and natural anatomical alignment. Preserve precisely: both characters crouched in tactical positions, male positioned on the left side of the frame, female positioned on the right side of the frame, futuristic body armor, yellow tactical glasses, weapon placement, shoulder angles, torso rotation, arm positions, and the relative distance between the subjects. Facial integration requirements: maintain original camera perspective, preserve correct facial foreshortening, match the exact viewing angle of each head, keep ears, jawline, cheekbones, and neck anatomy consistent with the original pose. Faces must conform naturally to the existing head orientation. No face swapping artifacts, no front-facing reconstruction, no profile distortion, no unnatural neck twisting, no head rotation mismatch. Perfectly match: cinematic lighting, warm indoor sunlight, realistic shadows, movie-grade color grading, shallow depth of field, realistic skin texture, detailed armor materials, photorealistic reflections on yellow glasses, natural facial micro-details. Anatomy: correct fingers, correct hand grip on weapons, no fused or extra fingers, no duplicated limbs, natural shoulders, realistic neck anatomy, correct eye alignment, proper facial perspective, physically accurate body proportions. Preserve: original background, framing, camera angle, tactical tension, cinematic atmosphere, environmental lighting, depth, and composition. Ultra photorealistic DSLR movie still, Hollywood sci-fi action film frame, highly detailed skin texture, realistic anatomy, seamless identity replacement, physically accurate facial perspective, cinematic lighting, professional color grading. Negative prompt: extra fingers, fused fingers, duplicated limbs, malformed hands, bad anatomy, distorted face, warped jawline, asymmetrical eyes, incorrect facial perspective, front-facing face on angled head, twisted neck, rotated head, broken posture, face swap artifacts, poor compositing, CGI, cartoon, anime, blurry, low detail, watermark, text, logo, unnatural gaze direction, misaligned eyes, stretched facial features, deformed ears, unrealistic skin, plastic skin, uncanny valley.`;
