...
REFERENCE SCENE DETAILS:
A small white wooden rowboat drifting through a flooded cypress forest/swamp.
Two characters sitting close together inside the boat.
Male character rowing while turning his head slightly backward.
Female character seated opposite him with open emotional expression and relaxed posture.
Golden-hour sunlight filtering through tall swamp trees.
Natural reflections on dark still water.
Soft cinematic backlight with realistic shadow falloff.
Shallow depth of field with layered forest depth.
...
The generated people must look unmistakably identical to the uploaded photos under cinematic outdoor lighting conditions.
...
— same eye direction
— same conversational focus
— same subtle emotional warmth
— same eyelid openness
— same eyebrow tension
— same relaxed intimacy
— same natural mouth tension
— same candid interaction energy
...
— rowing posture
— torso orientation
— boat positioning within frame

But rebuild anatomy using ONLY the uploaded people.

ENVIRONMENT:
Preserve:
— flooded forest/swamp environment
— tall cypress trees
— realistic water reflections
— natural vegetation density
— atmospheric depth
— cinematic sunlight rays through trees
— authentic outdoor humidity feel

Do NOT:
— alter the environment into fantasy scenery
— oversaturate foliage
— create artificial HDR lighting
— add unrealistic fog
— generate fake reflections

CLOTHING:
Use realistic casual outdoor clothing inspired by each uploaded person’s natural style and silhouette.
Avoid costume-like adaptation.
Clothing should feel naturally worn and physically grounded in the environment.
...
— artificial skin smoothing
— waxy skin
— unrealistic sunlight hotspots
— mismatched color temperature
— pasted-on faces

Lighting must follow:
— soft cinematic golden-hour sunlight
— realistic directional outdoor lighting
— physically accurate shadow placement
— natural tree shadow occlusion
— smooth cinematic contrast
— subtle ambient bounce from water
— realistic skin reflectivity only
...
IMAGE STYLE:
Photorealistic cinematic still frame.
Natural romantic indie-drama aesthetic.
Authentic analog-film feel.
Subtle film grain.
Shallow depth of field.
No AI glamour look.
No hyper-detailing.
...
The final image must look like a real cinema frame captured on a professional movie camera with the uploaded people physically present in the swamp environment.`;
