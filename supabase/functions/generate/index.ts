...
const WALLSTREET_2 = `Replace the person in the template image with the person from the uploaded reference photo. Use the reference photo to capture the person's appearance, including facial features, hairstyle, skin tone, and overall look.
